...
<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
 ...
 <div class="container">
 	<div class="row">
 		<div class=" card col-md-12 col-12 col-sm-12 text-info bg-primary shadow-1-strong" style="margin-top: 31px; margin-bottom:-36px;">
 			<h3 class="offset-md-4 text-info pt-2 text-white"style="
