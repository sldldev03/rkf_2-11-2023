...
//
	...
	QB::table('foundation_member')->where('id',
     $getID)->update($data);
    header("insert.php");
     					...
     					<form action="" method="POST" enctype="multipart/form-data">
     						<div class="row">
     							<div class="col-md-12">
     								<div class="mb-4">
     									<label>Name</label>
                                        <input type="text" name="fname"  value="<?php echo $all_data->fname; ?>" class="form-control" >
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="designation"  value="<?php echo $all_data->designation; ?>" class="form-control" >
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        <label>Best Quotes</label>
                                        <input type="text" name="description"  value="<?php echo $all_data->description; ?>" class="form-control" >
                                    </div>
                                </div>
