...
// include 'session.php';
 ...
 $values = QB::query("SELECT * FROM our_activites")->get();
...
<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
 ...
 <div class="container">
  <div class="row">
    <div class="card col-md-12 col-12 col-sm-12 text-black bg-light shadow-1-strong" style="margin-top: 31px; margin-bottom:-36px;">
      <h3 class="offset-md-4 pt-2 text-black"style="
    margin-left: 42.333333%;">Our Activites</h3>
      <table id="table_id" class="table text-black" >
                <thead>
                     <tr>
                        <th>Donation Type</th>
                        <th>Image</th>
                 ...
                 ?>
                  ...
                  <tbody>
                     <tr>
                         ...
                         <td><img src="../admin/images/<?php echo $value->image ;?>" width="300px" height="200px"></td>                    
...
<!-- <div class="container">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="../admin/images/<?php echo $value->image ;?>"  class="">
      <div class="carousel-caption d-none d-md-block">
        <h4 style="
    margin-left: 5%;"><?php echo $value->donation_type;?></h4>
                      <span style="
    margin-left: 5%;"><?php echo $value->date;?></span>
    ...
    <div class="carousel-item" data-bs-interval="2000">
      <img src="../admin/images/<?php echo $value->image ;?>" class="d-block ">
      <div class="carousel-caption d-none d-md-block">
        <h4 style="
    margin-left: 5%;"><?php echo $value->donation_type;?></h4>
                      <span style="
...
<!---another start ---->
 <!-- <div class="container">
  <div class="row">
    <div class="col-md-12" style="margin-top: 31px; margin-bottom:-36px;">
      <h3 class="offset-md-4 pt-2 text-info"style="
    margin-left: 42.333333%;">Our Activites</h3>
    ...
    margin-left: 5%;"><?php echo $value->date;?></span>
                    <div class="card col-md-4">
                         ...
                         <h3><img src="../admin/images/<?php echo $value->image ;?>" width="370px" height="230px"></h3>                    
