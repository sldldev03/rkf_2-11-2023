...
$all_data=QB::query("SELECT * FROM `our_activites` WHERE id='$getID' ")->first();
...
//
    ...
    QB::table('our_activites')->where('id',
     $getID)->update($data);
    header("our_activites.php");
...
?>
 ...
 <body>
    <h3 class="offset-md-2 text-info text-center mt-2"style="font-weight: bold;">Our Activites</h3>
             ...
             <div class="mb-4">
                    ...
                    <input type="hidden" name="old_slide" value="<?php if(!empty($all_data)){ echo $all_data->image; } ?>" class="form-control"> <br>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="donation_type"  value="<?php echo $all_data->donation_type; ?>" class="form-control" >
                                    </div>
                                </div>
                                   ...
                                   <div class="col-md-12">
                                    <div class="mb-4">
                                        <label>Date</label>
                                        <input type="date" name="date"  value="<?php echo $all_data->date; ?>" class="form-control" >
                                    </div>
                                </div>
